...
import com.quickcommerce.Seguridad.JWTFiltroAuthorization;
import com.quickcommerce.exception.ExceptionGlobalHandler;

//@EnableTransactionManagement
//@EnableJpaRepositories("com.quickcommerce.Repository")
@Configuration
@SpringBootApplication
public class QuickCommerceApp {

	public static void main(String[] args) {
		SpringApplication.run(QuickCommerceApp.class, args);
	}
