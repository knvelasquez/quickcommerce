 ...
 * 
 */
package com.quickcommerce.Seguridad;
...
import com.quickcommerce.exception.EncabezadoNoEcontradoExeption;
import com.quickcommerce.exception.ExceptionGlobalHandler;
import com.quickcommerce.exception.PrivilegioNoEcontradoException;
	...
	public void doFilterInternal(HttpServletRequest solicitud, HttpServletResponse respuesta,
		...
		try {
			if (existeJwtToken(solicitud, respuesta)) {
				...
				if (!solicitud.getRequestURI().equals("/quickcommerce/usuario")) {
