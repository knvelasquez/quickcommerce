...
public class httpUtil {
	...
	String urlSuperHeroePorID = "/quickcommerce/superheroe/:id";
	String urlSuperHeroeNombreContenga = "/quickcommerce/superheroe/nombre/:nombre";
	/**
	 * 
	 * 
	 * */
	...
	protected String autenticar(UsuarioSolicitud usuario,int estatus,Boolean notNull) throws UnsupportedEncodingException, Exception {
		//Assert
		EntidadRespuesta<String> autenticacionResultado=mvc(http.POST, urlUsuario, usuario, mapTipoString);
		//Act
